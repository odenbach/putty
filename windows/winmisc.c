...
char *get_username(void)
{
	...
	if (!tried_usernameex) {
	    ...
	    /* If MIT Kerberos is installed, the following call to GetUserNameExA
	       makes Windows implicitly load sspicli.dll WITHOUT proper path
	       sanitizing, so better load it properly before */
